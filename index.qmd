    ...
    include-after-body:
      - text: |
          ...
          function colorizeTitleSlide() {
            ...
            const colored = words.slice(0, 3)
              .map((word, i) => `<span class="title-word-${i}">${word}</span>`)
              .join(" ");
            const rest = words.slice(3).join(" ");
            title.innerHTML = rest ? `${colored} ${rest}` : colored;
...
[Click here to view report](https://mattkumar.github.io/genai_day_2026/beacon-01.html){target="_blank" rel="noopener noreferrer"}
